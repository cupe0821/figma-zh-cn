...
这是一个面向 Figma 桌面版的非官方简体中文翻译与本地维护项目。当前基线为 **Figma 126.6.14 / 中文包 126.6.14-cn.6**，包含 4509 条累计词典、着色器与 AI 界面动态翻译、原生菜单翻译和轻量动态界面运行时。
...
| macOS Apple Silicon | `macos-arm64` | 已在 126.6.14 实机验证 |
