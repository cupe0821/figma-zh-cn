...
这是一个面向 Figma 桌面版的非官方简体中文翻译与本地维护项目。当前基线为 **Figma 126.6.14 / 中文包 126.6.14-cn.4**，包含 4461 条累计词典、着色器与 AI 界面动态翻译、原生菜单翻译和防闪烁运行时。
...
4. 安装器会备份原始 `app.asar`、写入中文加载器、同步更新 Figma 的 ASAR 尾部大小标记、重新签名并启动 Figma。
