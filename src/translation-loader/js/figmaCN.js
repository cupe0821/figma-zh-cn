...
Object.assign(map,{
  ...
  "Shader effect":"着色器效果","Shader fill":"着色器填充","Custom effect":"自定义效果","Custom fill":"自定义填充","Create new":"新建","Created by me":"由我创建","In this file":"此文件中","New shader":"新建着色器","No results":"无结果","Search all tools":"搜索所有工具","Filter by source":"按来源筛选","Filter by category":"按分类筛选","Filter by price and type":"按价格和类型筛选","Clear search":"清除搜索","From Figma":"由 Figma 提供","Suggested":"建议","Recent":"最近",
  "Agents":"智能体","Assets":"资源","Tools":"工具","Variables":"变量","Main menu":"主菜单","File":"文件","Create new comment":"新建评论","Left sidebar":"左侧边栏","Right sidebar":"右侧边栏","Navigation Bar":"导航栏","Share":"分享","Present":"演示","Multiplayer tools":"协作工具","Prototype view":"原型视图","Apply variable mode":"应用变量模式","Create style":"创建样式","Add export settings":"添加导出设置","Toolbelt Mode":"工具栏模式","Move":"移动","Copy colors":"复制颜色","Measurement":"测量","Annotation":"批注","Comment":"评论","Move tools":"移动工具","Frame":"画框","Region tools":"区域工具","Rectangle":"矩形","Shape tools":"形状工具","Pen":"钢笔","Creation tools":"创建工具","Text":"文本","Type tools":"文本工具","Comment tools":"评论工具","Actions":"操作","Help/zoom toolbar":"帮助/缩放工具栏","Help":"帮助","Close":"关闭","Resize handle":"调整大小手柄","More actions":"更多操作","Loading":"正在加载","View mode":"查看模式","New file":"新建文件","Show navigation":"显示导航","Show as grid":"网格显示","Show as list":"列表显示","Help and resources":"帮助与资源","Notifications":"通知",
  "About Figma":"关于 Figma","Preferences":"偏好设置","Snap to Geometry":"吸附到几何图形","Snap to Objects":"吸附到对象","Snap to Pixel Grid":"吸附到像素网格","Keep Tool Selected After Use":"使用后保持工具选中","Highlight Layers on Hover":"悬停时高亮图层","Rename Duplicated Layers":"重命名重复图层","Show Dimensions on Objects":"显示对象尺寸","Hide Canvas UI During Changes":"更改时隐藏画布界面","Use Smart Quotes/symbols":"使用智能引号和符号","Flip Objects While Resizing":"调整大小时翻转对象","Keyboard Zooms into Selection":"键盘缩放至所选内容","Invert Zoom Direction":"反转缩放方向","Ctrl+click Opens Right Click Menus":"Ctrl+单击打开右键菜单","Use Number Keys for Opacity":"使用数字键设置不透明度","Use Old Shortcuts for Outlines":"使用旧版轮廓快捷键","Use ⌘⌥↑/↓ to Rotate Layers":"使用 ⌘⌥↑/↓ 旋转图层","Play Audio Notifications in AI Chat":"在 AI 聊天中播放声音通知","Show Text Suggestions":"显示文本建议","Show Tool Suggestions":"显示工具建议","Show Agents on Canvas":"在画布上显示智能体","Use Scroll Wheel Zoom":"使用滚轮缩放","Right-click and Drag to Pan":"右键拖动平移","Nudge Amount…":"微移量…","Hide Figma":"隐藏 Figma","Help Page":"帮助页面","Keyboard Shortcuts":"键盘快捷键","Support Forum":"支持论坛","Video Tutorials":"视频教程","Release Notes":"版本说明","Legal Summary":"法律摘要","Account Settings":"账户设置","Development":"开发","Manage plugins…":"管理插件…","Manage widgets…":"管理小部件…","Select all widgets":"选择所有小部件","Sort Position":"按位置排序","Sort Position (children)":"按位置排序（子项）","Sort Alpha Asc.":"按字母升序","Sort Alpha Asc. (children)":"按字母升序（子项）","Sort Alpha Dsc.":"按字母降序","Sort Alpha Dsc. (children)":"按字母降序（子项）","Sort Reverse":"反向排序","Sort Reverse (Children)":"反向排序（子项）","Sort Random":"随机排序","Sort Random (children)":"随机排序（子项）","New Design File":"新建设计文件","New FigJam File":"新建 FigJam 文件"
});
Object.assign(map,{
  "Expand image":"扩展图像","Erase object in image":"擦除图像中的对象","Isolate object in image":"分离图像中的对象","Remove object in image":"移除图像中的对象","Separate object in image":"分离图像中的对象","Upscale image":"提升图像分辨率","Boost resolution":"提升分辨率","Enhance resolution":"提升分辨率","Edit image":"编辑图像","Edit image with prompt":"使用提示词编辑图像","Edit image with a prompt":"使用提示词编辑图像","Use prompt to edit image":"使用提示词编辑图像","Generate image":"生成图像","Make an image":"生成图像","Replace background":"替换背景","Remove background":"移除背景","Change lighting":"更改光照","Vectorize image":"图像矢量化","Crop image":"裁剪图像",
  "New chat":"新对话","Start new chat":"开始新对话","What do you want to do?":"你想做什么？","Design the next screen":"设计下一个界面","Design next screen":"设计下一个界面","Create variations":"创建变体","Create plugins and shaders":"创建插件和着色器","Describe your idea":"描述您的想法","Chat history":"对话历史","Search chats":"搜索对话","No messages":"暂无消息","No matching chats":"没有匹配的对话","Not started":"尚未开始","Hide assistant":"隐藏智能体","Make all chats private":"将所有对话设为私密","New chat title":"新对话","Shared":"已共享","Private":"私密","Today":"今天","This week":"本周","Last week":"上周","Earlier":"更早","Sort by date":"按日期排序","Sort by unread":"按未读排序","Only mine":"仅我的","All chats":"所有对话","Unread":"未读","Send":"发送","Stop":"停止","Retry":"重试","Try again":"重试","Undo changes":"撤销更改","Keep changes":"保留更改","Accept":"接受","Reject":"拒绝","Apply":"应用","Attach":"附加","Add context":"添加上下文","Thinking":"思考中","Working":"处理中","Ask Figma":"询问 Figma","Figma Agent":"Figma 智能体","AI chat":"AI 对话",
  "Color filter":"色彩滤镜","Brilliance":"鲜明度","Definition":"清晰度","Lenticular":"柱状透镜","Zigzag":"锯齿","Wave":"波纹","Curved square":"曲边方形","Flat square":"平面方形","Edge wrap":"边缘环绕","Zero":"零值","Wrap":"环绕","No wrap":"不环绕","Transparent":"透明","Reflect":"反射","Border":"边界","Preserve aspect ratio":"保持宽高比","Nearest":"最近邻","Cubic":"三次插值","Bicubic":"双三次插值","Smoothstep":"平滑阶跃","Luminance":"亮度","Luminosity":"明度","Sepia":"棕褐色","Vintage":"复古","Cool":"冷色","Warm":"暖色","Vivid":"鲜艳","Dramatic":"戏剧化","Fade":"褪色","Noir":"黑白","Process":"冲印","Transfer":"转移","Instant":"即时","Original":"原始","Amount X":"横向量","Amount Y":"纵向量","Scale X":"横向缩放","Scale Y":"纵向缩放","Offset X":"横向偏移","Offset Y":"纵向偏移","Frequency X":"横向频率","Frequency Y":"纵向频率","Amplitude X":"横向振幅","Amplitude Y":"纵向振幅","Radius X":"横向半径","Radius Y":"纵向半径","Strength X":"横向强度","Strength Y":"纵向强度","Edge mode":"边缘模式","Wrap mode":"环绕模式","Interpolation":"插值方式","Color filter opacity":"色彩滤镜不透明度"
});
Object.assign(map,{
  "Color trim":"色彩裁剪","Average color":"平均颜色","Dissolve mode":"溶解模式","Dropout":"随机脱落","Knockout":"镂空",
  "Dissolve":"溶解","Decay":"衰减","Shape mode":"形状模式","Sampling mode":"采样模式","Sample mode":"采样模式","Average":"平均值","Dominant color":"主色","Original color":"原始颜色",
  "Fixed width":"固定宽度","Fixed Width":"固定宽度","Fixed height":"固定高度","Fixed Height":"固定高度","Hug contents":"适应内容","Fill container":"填充容器",
  ...
  "Static":"静态","Animated":"动画","Format":"格式","Frame rate":"帧速率","Export frame":"导出帧","Export animation":"导出动画","File size":"文件大小","Duration":"持续时间","Delay":"延迟","Easing":"缓动","Ease in":"缓入","Ease out":"缓出","Ease in and out":"缓入缓出"
});
Object.assign(map,{
